...
export interface ExerciseListItem {
  ...
  readonly warning?: boolean;
  /** Screen-reader text read before the title of a `warning` row (issue #57: "Overdue:"), since
   * the warning icon itself is decorative. Already translated, punctuation included (the list adds
   * none); ignored without `warning`. */
